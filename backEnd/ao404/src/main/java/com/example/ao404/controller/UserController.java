...
public class UserController {
    ...
    @ApiOperation(value = "忘记密码的修改密码，前端先验证邮箱后再直接调此接口")
    @PostMapping("forgetPassword")
    public Map<String, Object> forgetPassword(int userId, String newPassword) {
        Map<String, Object> map = new HashMap<>();
    ...
    public Map<String, Object> resetPassword(HttpServletRequest request, String oldPassword, String newPassword) {
        ...
        System.out.println(userMapper.loginUser(userId).getUserPassword());
        System.out.println(oldPassword);
//        if(!userMapper.loginUser(userId).getUserPassword().equals(oldPassword))
//        {
//            map.put("msg","原密码错误");
//            helper.setMsg("Error");
//            helper.setData(map);
...
//        }
    ...
    public Map<String, Object> resetName(HttpServletRequest request, String newName) {
    ...
    @PostMapping("follow")
    public Map<String, Object> follow(HttpServletRequest request, int followingId) {
        GetInformationFromRequest getInfo = new GetInformationFromRequest(request);
        int userId = getInfo.getUserId();


        Map<String, Object> map = new HashMap<>();
        relationMapper.follow(userId, followingId);
    ...
    public Map<String, Object> unfollow(HttpServletRequest request, int followingId) {
        GetInformationFromRequest getInfo = new GetInformationFromRequest(request);
        int userId = getInfo.getUserId();


        Map<String, Object> map = new HashMap<>();
        relationMapper.unfollow(userId, followingId);
